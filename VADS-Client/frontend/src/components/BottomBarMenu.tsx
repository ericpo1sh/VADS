...
export const BottomBarMenu: React.FC<BottomBarMenuProps> = ({ setActiveComponent, activeComponent }) => {
  ...
  return (
    <div style={{ display: "flex", flexDirection: 'column', width: '15%', height: '95%', margin: '7px 0px 7px 12px', borderRadius: '20px 20px 20px 20px', justifyContent: 'space-evenly', alignContent: 'center', alignItems: 'center' }}>
