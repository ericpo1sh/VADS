...
export const Settings: React.FC = () => {
  ...
  useEffect(() => {
    ...
    checkPortStatus();
    const intervalId = setInterval(checkPortStatus, 5000);
  ...
  return (
    <div style={{ width: '100%', border: '4px solid white', height: '80px', marginTop: '-3px', position: 'relative', backgroundColor: '#323232' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginRight: 'auto', marginLeft: '15px', marginTop: '23px' }}>
        ...
        <div
          style={{
            ...
            height: '20px',
            borderRadius: '50%',
            backgroundColor: portStatus === true ? 'green' : 'red',
          }}
        />
      </div>
      ...
      {isSettingsOpen && (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'absolute', top: '-668px', right: '0px', width: '400px', height: '660px', backgroundColor: '#323232', zIndex: 10, fontFamily: 'Roboto Mono' }}>
